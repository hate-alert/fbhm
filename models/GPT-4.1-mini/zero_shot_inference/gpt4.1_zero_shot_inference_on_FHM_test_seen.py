...
OUTPUT_TXT = "./gpt4.1mini_zero_shot_inference_on_FHM_test_seen_output.txt"
...
class GPT4MiniInference:
    ...
    def predict(self, meme_data):
        """
        meme_data: dict with keys 'id', 'img', 'label', 'text' (from FHM test_seen)
        Returns generated answer string.
        """
        # Construct full image path: IMAGE_DIR / basename(sample['img'])
        img_rel = meme_data['img']                     # e.g. "img/12345.png"
