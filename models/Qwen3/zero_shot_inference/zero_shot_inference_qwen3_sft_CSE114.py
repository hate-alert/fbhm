...
# OUTPUT_TXT = "normal_qwen3_zero_shot_inference_on_whole_FBHM_output.txt"
OUTPUT_TXT = "./qwen3_normal_then_FBHM_3_epochs_zero_shot_inference_on_FBHM_test_output.txt"
MAX_NEW_TOKENS = 50
TEMPERATURE = 0.001
...
def main():
    ...
    # Convert to dictionary records for easier handling
    ...
    with open(OUTPUT_TXT, "w", encoding="utf-8") as output_file:
        for index, meme_data in tqdm(enumerate(test_data), total=len(test_data), desc="Processing memes"):
            # Convert to pandas Series for consistency with your format
            ...
            # Add image path info for reference
