...
OUTPUT_DIR = "./qwen3-vl-8b-sft-fhm-15-epochs-earlystop"

HF_UPLOAD_NAME = "pbhaskar/qwen3-vl-8b-sft-fhm-15-epochs-earlystop"
...
def upload_to_hf(local_dir: str, repo_id: str, token: str) -> bool:
    try:
        ...
        upload_folder(
            ...
            commit_message="Qwen3-VL-8B fine-tuned on FHM dataset (QLoRA)",
            repo_type="model"
        )
